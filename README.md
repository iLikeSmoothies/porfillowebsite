...
- `resume.html` - Resume preview image, PDF open link, and download button
...
- Project files: add each project folder under `assets/images/projects/`, then manually add project sections in `projects.html`.
